...
@onready var player_paddle = $"../player-paddle"
@onready var enemy_paddle = $"../enemy-paddle"
...
func _set_difficulty(level: String):
	if level == "Easy":
		SPEED = 600
	elif level == "Normal":
		SPEED = 1000
